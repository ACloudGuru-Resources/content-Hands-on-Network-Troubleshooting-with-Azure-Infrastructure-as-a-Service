...
try {
    ...
    Invoke-WebRequest -Uri 'https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-aspnetcore-3.1.32-windows-hosting-bundle-installer' -OutFile 'C:\temp\dotnet-hosting.exe'
